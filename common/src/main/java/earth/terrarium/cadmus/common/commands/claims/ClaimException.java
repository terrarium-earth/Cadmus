...
public class ClaimException extends Exception {
    ...
    public static final ClaimException YOUVE_MAXED_OUT_YOUR_CLAIMS = new ClaimException(ModUtils.serverTranslation("command.cadmus.exception.maxed_out_claims"));
